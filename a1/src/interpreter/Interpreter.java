...
public class Interpreter implements StatementVisitor, ExpTransform<Value> {
     ...
     * and assign the value to the variable's offset within that frame.
     *
    ...
    private void assignValue(Value lValue, Value value) {
        ...
        /* Assign the variable's value to the offset in the frame */
    ...
    public void visitAssignmentNode(StatementNode.AssignmentNode node) {
        ...
        /* Evaluate the address of the variable.*/
        Value lValue = node.getLValue().evaluate(this);
        /* Evaluate the value to be assigned to the variable. */
        Value value = node.getExp().evaluate(this);
        /* Assign the value to the variable's address.*/
    ...
    /**
     * Expression evaluation for narrow sub-range - perform sub-range bound check
     */
    public Value visitNarrowSubrangeNode(ExpNode.NarrowSubrangeNode node) {
        ...
        /* Perform a sub-range bounds check for the value */
    ...
    /**
     * Expression evaluation for widen sub-range - evaluate subexpression
     */
